...
import json
from ceng445.monopoly.cell.Property import Property
from ceng445.monopoly.cell import Teleport
from ceng445.monopoly.cell.Tax import Tax
from ceng445.monopoly.cell.Jail import Jail
from ceng445.monopoly.cell import ChanceCard
from ceng445.monopoly.cell.Start import Start
from User import User
from ceng445.monopoly.cell.GotoJail import GotoJail
import random
...
class Board(models.Model):
    ...
    users = {}  # holds all the users, used dictionary for easy access (key = user_id)
    cells = []  # holds all the cells
    started = False  # boolean to check if the game has started, is used in main game loop
    userTurn = []
    turn_changed = True
    first_roll = True
    # id = board_id
